...
measurement_dao = MeasurementDao(time_tagger_builder)

time_tagger_measurement_service = MeasurementService(measurement_dao,measurement_data,time_tagger_builder)
